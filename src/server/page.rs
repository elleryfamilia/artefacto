...
pub fn served_document(rendered: &str, artifact: &str, revision: u32) -> String {
    rendered
        ...
        .replacen(
            ...
            "<div class=\"pv-topbar-right\"><a class=\"pv-topbar-link\" href=\"/\">\
<svg class=\"pv-topbar-link-icon\" viewBox=\"0 0 24 24\" aria-hidden=\"true\">\
...
</svg>All artifacts</a><span class=\"pv-topbar-sep\" aria-hidden=\"true\"></span>",
            1,
        )
}
