...
//! with the bare `<!-- artefacto:generated context=… -->` marker line (never
    ...
    let page = html! {
        ...
        html lang="en" {
            head {
                ...
                title { (plan.meta.title) " — artefacto plan" }
...
mod tests {
    ...
    fn document_structure() {
        ...
        assert!(html.starts_with(&crate::marker::line(&hash)));
    ...
    fn rendered_document_starts_with_the_contract_marker_line() {
        ...
        assert_eq!(
            first,
            crate::marker::line(&expected),
            "first line is the contract line"
        );
        assert_eq!(
