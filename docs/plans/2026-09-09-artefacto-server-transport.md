...
>
> `docs/BUILD-STATUS.md` is the current picture. Where this plan is wrong:
>
...
> - **`open` is still not implemented**, and `status --json` still returns a
>   minimal shape rather than the full contract in spec 5.
>
